...
#ifndef GZPLUGINZ_CUSTELEVATORPLUGINPRIVATE_HH_
#define GZPLUGINZ_CUSTELEVATORPLUGINPRIVATE_HH_
...
public:
  ...
  public:
    ...
    /// controlled.
  public:
    explicit DoorController(physics::JointPtr _doorJoint);
...
public:
  ...
  public:
    explicit CloseState(ElevatorPluginPrivate::DoorController *_ctrl);
...
public:
  class OpenState : public State {
    ...
    /// \param[in] _ctrl Elevator door controller
  public:
    explicit OpenState(ElevatorPluginPrivate::DoorController *_ctrl);
...
public:
  ...
  public:
    explicit WaitState(const common::Time &_waitTime);
